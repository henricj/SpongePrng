...
/**
  ...
  */
ALIGN typedef struct Keccak200_SpongeInstanceStruct {
...
/**
  ...
  */
int Keccak200_SpongeInitialize(Keccak200_SpongeInstance *spongeInstance, unsigned int rate, unsigned int capacity);
...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int Keccak200_SpongeAbsorb(Keccak200_SpongeInstance *spongeInstance, const unsigned char *data, size_t dataByteLen);
...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int Keccak200_SpongeAbsorbLastFewBits(Keccak200_SpongeInstance *spongeInstance, unsigned char delimitedData);
...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int Keccak200_SpongeSqueeze(Keccak200_SpongeInstance *spongeInstance, unsigned char *data, size_t dataByteLen);
